...
using FluentWeather.Core.Contracts.Services;
using FluentWeather.Core.Services;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<WeatherBasePage>();
            services.AddTransient<WeatherBaseViewModel>();
